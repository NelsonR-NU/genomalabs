...
const Hero = () => {
  return (
    <section className="relative h-screen flex items-center justify-center">
      ...
      <div className="flex justify-center items-center bg-gradient-to-t from-black/70 to-transparent gap-5 z-10 flex-1 text-center text-white absolute flex-grow w-full h-full">
